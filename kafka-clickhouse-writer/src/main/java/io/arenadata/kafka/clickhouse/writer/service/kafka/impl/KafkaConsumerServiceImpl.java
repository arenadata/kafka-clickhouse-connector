 ...
 */
package io.arenadata.kafka.clickhouse.writer.service.kafka.impl;
...
public class KafkaConsumerServiceImpl implements KafkaConsumerService {
    ...
    private KafkaConsumer<byte[], byte[]> createConsumer(Map<String, String> consumerProperty,
        ...
        consumer.exceptionHandler(it -> log.error("Error reading message from topic {}: {}", topicName, it.getMessage()));
        return consumer;
    }
    ...
    private Future<TopicPartitionConsumer> createTopicPartitionConsumer(Map<String, String> consumerProperty,
        ...
        val consumer = consumerFactory.create(consumerProperty);
        consumer.exceptionHandler(it -> log.error("Error reading message from TopicPartition {}: {}", partitionInfo, it.getMessage()));
