 ...
 */
package io.arenadata.kafka.clickhouse.writer.avro.codec.conversion;

import io.arenadata.kafka.clickhouse.writer.avro.codec.type.LocalDateTimeLogicalType;
...
public class LocalDateTimeConversion extends Conversion<LocalDateTime> {
    ...
    public LocalDateTime fromLong(Long value, Schema schema, LogicalType type) {
        return LocalDateTime.ofInstant(Instant.ofEpochMilli(value / 1000), ZoneId.systemDefault());
    }
